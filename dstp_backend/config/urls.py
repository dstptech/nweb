...
# ── All API v1 routes defined ONCE here ───────────────────────────────────────
# 
...
api_v1_patterns = [
    ...
    # Core tracking (was missing — now mounted so these APIs are reachable)
    path("track/",        include("apps.core.urls")),
]

# ── Main URL patterns ─────────────────────────────────────────────────────────
urlpatterns = [
    # All API v1 routes come from api_v1_patterns above — single source of truth
